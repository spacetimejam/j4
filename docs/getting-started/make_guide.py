...
story = [
 ...
 P("The wizard checks your machine, asks a short set of questions about you and your search, and builds your personal project folder, named after you (for example <font face='Courier'>job-search-sam</font>). When it finishes, it tells you the final step: open that new folder with your AI assistant and say <b>“run setup”</b>. The assistant then interviews you properly, builds your profile and CV materials, and from that point on you are running your search together."),
 H("Good to know"),
