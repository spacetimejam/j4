...
story = [
 ...
 C("git clone https://github.com/spacetimejam/j4\ncd j4 && ./setup/setup.sh"),
 P("The wizard checks your machine, asks a short set of questions about you and your search, and builds your personal project folder inside the kit, named with your initials (for example <font face='Courier'>j4/sj</font>). When it finishes, it tells you the final step: move into that new folder in the terminal and start your AI assistant from inside it, for example <font face='Courier'>cd ~/j4/sj</font> and then <font face='Courier'>claude</font>. Starting it from inside the folder is what lets the assistant see your project. Once it is running, say <b>“run setup”</b>. The assistant then interviews you properly, builds your profile and CV materials, and from that point on you are running your search together."),
 H("Good to know"),
